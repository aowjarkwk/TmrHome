...
<body>
    <div id="footer">
        ...
        <div class="footer">
            ...
            <div class="footer_info_company">COMPANY: <span class="emphasis">(주)내일의집</span>  | OWNER: Team-EUNOIA | BUISNIESS LICENSE:123-45-67890 <br>
            MAIL ORDER LICENSE:2020-노원상계-1004호 ADDRESS: 서울특별시 노원구 상계대로 33(EZENACADEMY)333호 <br>
            CHIEF PRIVACY OFFICER : 내일의집(tmorhome@naver.com) CALL CENTER:<span class="emphasis">1644-4931</span> | FAX : <span class="emphasis">031-711-0816</span> <br>
