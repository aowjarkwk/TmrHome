    ...
    <div class="wrap">
        ...
        <div class="section">
            <div class="aside">
                ...
                <div class="aside_menu active"><a href="mypage_one2one.html"> 1:1문의</a> <br></div>
            ...
            <div class="main">
                ...
                <div class="one2one_list">
                    ...
                    <div class="one2one_table">
                        <div class="one2one_header">
                            <div class="head">1:1문의 10건</div>
                        ...
                        <div class="th">
                            <div class="one2one_date">날짜</div>
                            <div class="one2one_subject">제목</div>
                            <div class="one2one_content">내용</div>
                            <div class="one2one_answer">답변여부</div>


                        </div>

                        <div class="td">
                            <div class="one2one_date">2021-08-05</div>
                            <div class="one2one_subject">3일이 지났는데 아직...</div>
                            <div class="one2one_content">배송완료 3일이 지났는데 아직 도착...</div>
                            <div class="one2one_answer">답변완료</div>
                            <div class="one2one_delete delete"><button class="skyblue">삭제</button></div>

                        </div>
                        <div class="td">
                            <div class="one2one_date">2021-08-04</div>
                            <div class="one2one_subject">이벤트 문의</div>
                            <div class="one2one_content">이벤트 당첨자는 어떤 절차를 통해서 상품...</div>
                            <div class="one2one_answer">미답변</div>
                            <div class="one2one_delete delete"><button class="skyblue">삭제</button></div>
