...
<head>
  ...
  <style>
    ...
    * {
    ...
    .product-inquiry-list .table {
      display: table;
      width: 100%;
    }
    .product-inquiry-list .row {
      display: table-row;
    }
    .product-inquiry-list .col1 {
      width: 8%;
    }
    .product-inquiry-list .col2 {
      width: 10%;
    }
    .product-inquiry-list .col3 {
      width: 10%;
    }
    .product-inquiry-list .col4 {
      width: 15%;
    }
    .product-inquiry-list .col5 {
      width: 49%;
    }
    .product-inquiry-list .col6 {
      width: 8%;
    }
    .answer-form {
      display: flex;
...
<body>
  ...
  <article class="content-wrap">
    ...
    <!-- ################################ 테이블 ################################ -->
    <section class="product-inquiry-list">
      <div class="table">
        <div class="table__header">
          <span class="cell col1">상품코드</span>
          <span class="cell col2">ID</span>
          <span class="cell col3">날짜</span>
          <span class="cell col4">상품명</span>
          <span class="cell col5">내용</span>
          <span class="cell col6">답변여부</span>
        </div>
      </div>
      ...
      <div class="table">
        <div class="row">
          ...
          <span class="cell col2">사용자1</span>
          <span class="cell col3">2021-08-26</span>
          <span class="cell col4">네이비 소파</span>
          <span class="cell col5">내용</span>
          <span class="cell col6">Y</span>
        </div>
      </div>
...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus pariatur non temporibus asperiores maxime, corrupti, praesentium doloribus atque minus earum, omnis consectetur. Quae quasi amet laboriosam repudiandae, facere quo dolor.</textarea>
      ...
      <div class="table">
        <div class="row">
          <span class="cell col1">10</span>
          <span class="cell col2">사용자2</span>
          <span class="cell col3">2021-08-26</span>
          <span class="cell col4">나무 의자</span>
          <span class="cell col5">내용</span>
          <span class="cell col6">N</span>
        </div>
      </div>
