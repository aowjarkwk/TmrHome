...
<body>
    ...
    <div class = "product_info_wrap">
        ...
        <div class = "section_wrap">
            ...
            <div class = "tr height_set_50">
                ...
                <div class = "td first_cate">
                    <select title = "product_cate1" name = "product_cate1">
                ...
                <div class = "td second_cate">
                    <select title = "product_cate2" name = "product_cate2">
                ...
                <!-- 제조사 -->
                <div class = "td made"><input type="text" name = "product_made"></div>
            </div>
        </div>
        ...
        <div class = "section_wrap">
            ...
            <div class = " height_set_300">
                ...
                <div class = "td_300_img img">
                    <p class = "img_text_set">대표 이미지</p>
                    <button class = "img_btn_set">이미지 추가</button>
                    <p class = "img_text_set img_margin">상품정보 이미지</p>
                    <button class = "img_btn_set">이미지 추가</button>
                </div>

                <!-- 상품설명 -->
                <div class = "td_300_info info_content">
                    <textarea class = "info_textarea" name = "product_content"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class = "section_wrap btn_top_margin">
            <div class = "button_div flexbox_col_align">
