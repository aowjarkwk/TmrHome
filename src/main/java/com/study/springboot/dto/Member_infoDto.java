...
public class Member_infoDto {
	...
	private String manager_flag;		  // 관리자 계정 여부
	...
	public Member_infoDto(String user_id, String user_password, String user_name, Date birthday, String email,
			String receive_email_flag, String phone_number, String receive_messages_flag, int postal_code,
			String address, String detailed_address, String pw_question, String pw_answer, Date member_since,
			String manager_flag, int mileage, int number_of_visits) {
		super();
